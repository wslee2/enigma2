...
# [ IQON : default skin changed force1
#if os.path.exists("/etc/.brandtype") and "worldvision" in open("/etc/.brandtype").readline():
DEFAULT_SKIN = "PLi-HD/skin.xml"
#
# changed skin PLi-HD because big problem in worldvision made skin.
#
#	DEFAULT_SKIN = "force1/skin.xml"
#else:
#	DEFAULT_SKIN = "PLi-HD/skin.xml"
