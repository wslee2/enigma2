...
class ChangeRCU(Screen, ConfigListScreen):
	...
	def __init__(self, session):
		...
		self.rculist.append("RCU for TM-SINGLE/TM-NANO-SERIES[ver1.0]")	# 4
...
class ChangeRCUWithoutRCU():
	def __init__(self):
		...
		self.devices = { "tm2toe":1, "tmtwinoe":2, "tmsingle":4, "tmnanooe":4, "tmnano2super":4, "force1plus":4 }
		self.models = { 1:"TM-2T-OE", 2:"TM-TWIN-OE", 4:"TM-SINGLE/TM-NANO-SERIES" }
