	...
	def __init__(self, session, type = 0, iface='eth0'):
		...
		if model == "force1plus":
			...
			if "technomate" in line:
				...
				self.imageInfo = { self.INTERNET_UPDATE : { "title" : "SW Update - "+lan, "imagedir" : "K3_OE3/te/"+modelDir+"_REL" },
					self.INTERNET_SR_UPDATE : { "title" : "SR SW Update - "+lan, "imagedir" : "K3_OE3/te/"+modelDir+"SR_REL" },
					self.INTERNET_UPDATE_BETA : { "title" : "SW Update (BETA) - "+lan, "imagedir" : "K3_OE3/te/"+modelDir },
					self.INTERNET_SR_UPDATE_BETA : { "title" : "SR SW Update (BETA) - "+lan, "imagedir" : "K3_OE3/te/"+modelDir+"SR" }
				}
			elif "edision" in line:
				modelDir = open("/proc/stb/info/modelname").read().strip('\n')
				self.imageInfo = { self.INTERNET_UPDATE : { "title" : "SW Update - "+lan, "imagedir" : "K3_OE3/ed/"+modelDir+"_REL" },
					self.INTERNET_SR_UPDATE : { "title" : "SR SW Update - "+lan, "imagedir" : "K3_OE3/ed/"+modelDir+"SR_REL" },
					self.INTERNET_UPDATE_BETA : { "title" : "SW Update (BETA) - "+lan, "imagedir" : "K3_OE3/ed/"+modelDir },
					self.INTERNET_SR_UPDATE_BETA : { "title" : "SR SW Update (BETA) - "+lan, "imagedir" : "K3_OE3/ed/"+modelDir+"SR" }
				}
			elif "worldvision" in line:
				modelDir = open("/proc/stb/info/modelname").read().strip('\n')
				self.imageInfo = { self.INTERNET_UPDATE : { "title" : "SW Update - "+lan, "imagedir" : "K3_OE3/wo/"+modelDir+"_REL" },
					self.INTERNET_SR_UPDATE : { "title" : "SR SW Update - "+lan, "imagedir" : "K3_OE3/wo/"+modelDir+"SR_REL" },
					self.INTERNET_UPDATE_BETA : { "title" : "SW Update (BETA) - "+lan, "imagedir" : "K3_OE3/wo/"+modelDir },
					self.INTERNET_SR_UPDATE_BETA : { "title" : "SR SW Update (BETA) - "+lan, "imagedir" : "K3_OE3/wo/"+modelDir+"SR" }
				}
			elif "swiss" in line:
				modelDir = open("/proc/stb/info/modelname").read().strip('\n')
				self.imageInfo = { self.INTERNET_UPDATE : { "title" : "SW Update - "+lan, "imagedir" : "K3_OE3/sw/"+modelDir+"_REL" },
					self.INTERNET_SR_UPDATE : { "title" : "SR SW Update - "+lan, "imagedir" : "K3_OE3/sw/"+modelDir+"SR_REL" },
					self.INTERNET_UPDATE_BETA : { "title" : "SW Update (BETA) - "+lan, "imagedir" : "K3_OE3/sw/"+modelDir },
					self.INTERNET_SR_UPDATE_BETA : { "title" : "SR SW Update (BETA) - "+lan, "imagedir" : "K3_OE3/sw/"+modelDir+"SR" }
				}
			elif "iqon" in line:
				modelDir = open("/proc/stb/info/modelname").read().strip('\n')
				self.imageInfo = { self.INTERNET_UPDATE : { "title" : "SW Update - "+lan, "imagedir" : "K3_OE3/iq/"+modelDir+"_REL" },
					self.INTERNET_SR_UPDATE : { "title" : "SR SW Update - "+lan, "imagedir" : "K3_OE3/iq/"+modelDir+"SR_REL" },
					self.INTERNET_UPDATE_BETA : { "title" : "SW Update (BETA) - "+lan, "imagedir" : "K3_OE3/iq/"+modelDir },
					self.INTERNET_SR_UPDATE_BETA : { "title" : "SR SW Update (BETA) - "+lan, "imagedir" : "K3_OE3/iq/"+modelDir+"SR" }
				}
			else:
				modelDir = open("/proc/stb/info/modelname").read().strip('\n')
