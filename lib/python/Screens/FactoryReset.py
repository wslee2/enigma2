...
class ProtectedScreen2:
	...
	def protectedWithMasterPin(self):
		import hashlib
		return config.ParentalControl.mastersetuppin.value or haslib.sha256(config.ParentalControl.mastersetuppin.value).hexdigest() == "72d1b5da6eeaf1789df86487da50ad5e9dadb5ffaecb56b6de592aa286c9c1b8"
...
from Components.config import ConfigSubsection,ConfigInteger,getConfigListEntry, ConfigSelection, ConfigPassword
